...
func main() {
	...
	fmt.Println("==================使用说明==================")
	fmt.Println("1. 进入魔兽 主城找个人少的地方")
	fmt.Println("2. 按F10开始/停止挂机")
	fmt.Println("3. 看到人物说话 '1'代表挂机开始 '2'代表挂机结束")
	fmt.Println()
	fmt.Println("防T机制: 模拟真人键盘操作, 不定期做随机移动等动作")
